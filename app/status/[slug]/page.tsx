...
const DEMO_FALLBACK_DATA: PublicStatusData = {
  ...
  monitors: [
    {
      ...
      checksHistory: Array.from({ length: 90 }, (_, i) => ({
        isSuccess: i !== 14 && i !== 52,
        responseTimeMs: 35 + ((i * 13) % 45),
  ...
  incidents: [
    {
      id: 'inc-1',
      statusPageId: 'demo-acme-status-page',
      title: 'Scheduled Database Maintenance & Index Optimization',
      status: 'Resolved',
      impact: 'Minor',
      message: 'Maintenance completed successfully. All operational metrics nominal.',
